...
echo "Running tests..."
docker exec iperf-client1 iperf3 -c iperf-server1 -t $test_duration -P $parallel_streams --get-server-output -l $buffer_length &> "iperf-client1.log" &
docker exec iperf-client2 iperf3 -c iperf-server2 -t $test_duration -P $parallel_streams --get-server-output -l $buffer_length &> "iperf-client2.log" &
